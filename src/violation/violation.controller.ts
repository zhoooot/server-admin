import { Body, Controller, Delete, Get, Inject, Param, Patch, Post, RequestMapping } from '@nestjs/common';
import { ViolationService } from './violation.service';
import {ViolationDto}  from '../dto/ViolationDto';

@Controller('violation')
export class ViolationController {
    constructor(@Inject(ViolationService) private readonly violationService: ViolationService) {}
